    ...
    <div className='min-h-screen relative flex flex-col md:flex-row'>
      <div className='flex flex-col p-8 md:w-2/3 lg:w-1/2 md:ml-20 mt-[240px]'>
        <div className='text-white flex flex-row items-center mb-4'>
          ...
          <p className='font-acme text-base'>Hello, <span className='text-Color3'>I'm</span></p>
        </div>
        ...
        <div className='text-white flex justify-start space-x-6 text-xl mt-40'>
          <FontAwesomeIcon icon={faGithub} className='cursor-pointer transition-all duration-300 ease-in-out hover:scale-150 hover:underline hover:text-Color3' />
          <FontAwesomeIcon icon={faInstagram} className='cursor-pointer transition-all duration-300 ease-in-out hover:scale-150 hover:underline hover:text-Color3' />
          <FontAwesomeIcon icon={faLinkedin} className='cursor-pointer transition-all duration-300 ease-in-out hover:scale-150 hover:underline hover:text-Color3' />
          <FontAwesomeIcon icon={faFacebook} className='cursor-pointer transition-all duration-300 ease-in-out hover:scale-150 hover:underline hover:text-Color3' />
          <FontAwesomeIcon icon={faTwitter} className='cursor-pointer transition-all duration-300 ease-in-out hover:scale-150 hover:underline hover:text-Color3' />
        </div>
      </div>

      <div className='md:w-1/3 lg:w-1/2 mt-8 md:mt-10'>
        <img src={image1} alt="My image" className='mt-[175px] w-full h-auto max-h-[600px] object-contain' />
      </div>
    </div>
  );
}
